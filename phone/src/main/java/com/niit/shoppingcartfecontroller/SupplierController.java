...
{
	ModelAndView s=new ModelAndView("RetriveSupplier");
	return s;		
}
...
public String addsupplier(HttpServletRequest request,@Valid @ModelAttribute("Supplier")Supplier supplier,@Valid @ModelAttribute("Category")Category category,BindingResult result)
       {
 System.out.println("values are successfully inserted");
     ...
     category.setId(supplier.getCategoryid());
...
public ModelAndView editsupplier(@RequestParam int id){
 ...
 System.out.println("suppliers"+sc.getCategoryname());
